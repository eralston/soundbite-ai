...
//            EmailNotificationService emails = new EmailNotificationService(Builder.Mapper.Value, emailTemplates, mailbox, Builder.Infrastructure.Value, new NullLogger<EmailNotificationService>());
//            MockSmsGateway smsGateway = new MockSmsGateway();
//            SmsNotificationService sms = new SmsNotificationService(smsGateway, Builder.Infrastructure.Value, new NullLogger<SmsNotificationService>());
...
//            Mock<ISbNotificationService> teamsMock = new Mock<ISbNotificationService>();
//            CompositeNotificationService notifications = new CompositeNotificationService(NullLogger<CompositeNotificationService>.Instance, emails, sms, teamsMock.Object, Builder.Infrastructure.Value, Builder.Rbac.Value);
...
//            CompositeNotificationService notifications = new CompositeNotificationService(
...
//            CompositeNotificationService notifications = new CompositeNotificationService(Builder.Logger<CompositeNotificationService>(), emails, sms, teamsMock.Object, Builder.Infrastructure.Value, Builder.Rbac.Value);
